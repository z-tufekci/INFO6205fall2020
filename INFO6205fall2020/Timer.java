...
public class Timer {
	 ...
	 * @param function
	 *            a function which yields a T (T may be Void).
	 ...
	 *            the number of repetitions.
	 * @param supplier
	 *            a function which supplies a different T value for each repetition.
	 * @param function
	 *            a function T=>U and which is to be timed (U may be Void).
	 * @return the average milliseconds per repetition.
	 */
	 ...
	 *            the number of repetitions.
	 * @param supplier
	 *            a function which supplies a T value.
	 * @param function
	 *            a function T=>U and which is to be timed.
	 * @param preFunction
	 *            a function which pre-processes a T value and which precedes the
	 *            call of function, but which is not timed (may be null).
	 * @param postFunction
	 *            a function which consumes a U and which succeeds the call of
	 ...
	 *
	 * @throws TimerException
	 *             if this Timer is already running.
	 */
	public void resume() {
		if (running)
			throw new TimerException();
	...
	private static long getClock() {
		...
		/*
		 * I am a bit confused about this. Prof says to use nanoTime() but it works well with currentTimeMillis() method
		 * */
	}
	 ...
	 *
	 * @param ticks
	 *            the number of clock ticks -- currently in nanoseconds.
