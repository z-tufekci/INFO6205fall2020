...
public class Timer {
    ...
    public void pauseAndLap() {
        lap();
        //System.out.println("pauseandlap1 "+ticks);
        ticks += getClock();
        //System.out.println("pauseandlap2 "+ticks);
        running = false;
    }
    ...
    public void resume() {
    	//running -> false
        if (running) throw new TimerException();
        //System.out.println("Resume: "+getClock());
        //System.out.println("ticks1: "+ticks);
        ticks -= getClock();
        //System.out.println("ticks2: "+ticks);
        running = true;
    }
