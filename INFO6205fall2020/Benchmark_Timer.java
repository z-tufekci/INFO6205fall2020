 ...
 *
 * @param <T> The generic type T is that of the in.....put to the function f which you will pass in to the constructor.
 */
public class Benchmark_Timer<T> implements Benchmark<T> {
	...
	public static void main(String args[]) {
		...
		//Benchmark_Timer<Integer> bt= new Benchmark_Timer<Integer>();
	}
    /**
